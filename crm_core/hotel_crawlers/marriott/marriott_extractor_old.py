...
from random_useragent import get_random_sec_ch_headers, USER_AGENT
...
if __name__ =="__main__":
    ...
    crawl.get_search_data("nycmt-courtyard-new-york-manhattan-soho", "2026-01-17", "2026-01-19",1)